...
public class GenericEditorViewerBase extends Viewer {

	protected final SourceViewer sourceViewer;

	protected IEditorInput editorInput;

	public GenericEditorViewerBase(Composite parent, CompositeRuler verticalRuler, int styles) {
		sourceViewer = new SourceViewer(parent, verticalRuler, styles);
